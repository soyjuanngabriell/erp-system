-- =====================================================
-- QUICK FIX FOR PAYMENT_METHOD FIELD ERROR
-- =====================================================
-- This fixes the error: record "order_record" has no field "payment_method"
-- Run this in Supabase SQL Editor

-- Drop and recreate the function with proper payment_method handling
...
-- Test the function
SELECT 'convert_order_to_invoice function fixed successfully!' as result;
