-- =====================================================
-- COMPLETE FIX FOR ALL INVOICE CONVERSION ERRORS
-- =====================================================
-- This script fixes all issues with invoice conversion:
-- 1. Function overload resolution
-- 2. Payment method field error
-- 3. Ambiguous column reference error
...
-- Create unified get_next_invoice_number function
...
-- Create completely fixed convert_order_to_invoice function
...
BEGIN
  ...
  -- Update order with invoice reference (FIXED: specify table name to avoid ambiguity)
...
-- Ensure invoice_sequences table exists with correct data
...
-- Test the functions
SELECT 'All invoice functions created successfully!' as result;
